	...
	<div class="container py-5">
		<div class="row mt-5">
			<?php
				...
				if($id=='mobiles')
				{
					$sql="SELECT * FROM mobiles WHERE category='mobiles' ";
				}

				elseif($id=='motors')
				{
					$sql="SELECT * FROM mobiles WHERE category='motors' ";
				}

				elseif($id=='electronics')
				{
					$sql="SELECT * FROM mobiles WHERE category='electronics' ";
				}

				elseif($id=='sports')
				{
					$sql="SELECT * FROM mobiles WHERE category='sports' ";
				}

				elseif($id=='fashion')
				{
					$sql="SELECT * FROM mobiles WHERE category='fashion' ";
				}

				elseif($id=='beauty')
				{
					$sql="SELECT * FROM mobiles WHERE category='beauty' ";
				}

				elseif($id=='appliances')
				{
					$sql="SELECT * FROM mobiles WHERE category='appliances' ";
				}
